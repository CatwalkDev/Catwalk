...
# Ad-hoc signing by default. Set CATWALK_SIGN_ID to a codesigning identity hash to sign
# with it instead (keeps the Accessibility grant across rebuilds during development):
